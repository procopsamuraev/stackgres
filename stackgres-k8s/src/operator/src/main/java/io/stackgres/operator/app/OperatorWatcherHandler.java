...
@ApplicationScoped
public class OperatorWatcherHandler implements WatcherHandler {

  private final List<WatcherMonitor<?>> monitors = new ArrayList<>();

  private final KubernetesClient client;
  private final ConfigReconciliator operatorConfigReconciliationCycle;
  ...
  @Inject
  public OperatorWatcherHandler(KubernetesClient client,
      ConfigReconciliator operatorConfigReconciliationCycle,
    ...
    this.client = client;
    this.operatorConfigReconciliationCycle = operatorConfigReconciliationCycle;
  ...
  private Consumer<Action> reconcileOperatorConfig() {
    return action -> operatorConfigReconciliationCycle.reconcile();
  }
