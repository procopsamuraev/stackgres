...
public class ConfigResourceGenerationDiscoverer
    extends ResourceDiscoverer<ResourceGenerator<StackGresConfigContext>>
    implements ResourceGenerationDiscoverer<StackGresConfigContext> {

  @Inject
  public ConfigResourceGenerationDiscoverer(
      @Any
          Instance<ResourceGenerator<StackGresConfigContext>> instance) {
    init(instance);
  }

  @Override
  public List<ResourceGenerator<StackGresConfigContext>> getResourceGenerators(
  ...
  private boolean applyKubernetesVersionBinder(Integer major, Integer minor,
      ResourceGenerator<StackGresConfigContext> generator) {
